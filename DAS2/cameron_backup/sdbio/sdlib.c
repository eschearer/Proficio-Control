/*
Generated 30-May-2002 13:08:30 by SD/FAST, Kane's formulation
...
void sddc2ang(double dircos[3][3],
    double *a1,
    double *a2,
    double *a3)
{
...
void sddc2quat(double dircos[3][3],
    double *e1,
    double *e2,
    double *e3,
    double *e4)
