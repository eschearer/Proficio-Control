/*
Generated 30-May-2002 13:08:30 by sdinv/FAST, Kane's formulation
(sdinvfast B.2.8 #30123) on machine ID unknown
...
#define lasterr (sdinvgerror.lasterr_)
#define lastrou (sdinvgerror.lastrou_)

sdinvgerror_t sdinvgerror = {
/* Error parameters
*/
    /* lasterr */ 0,
    /* lastrou */ 0,
    ...
    int errnum)
{
    ...
    fprintf(fnum,"\n");
    if (routine == 1) {
        fprintf(fnum,"sdinvgrav:\n");
    }
    if (routine == 2) {
        fprintf(fnum,"sdinvmass:\n");
    }
    if (routine == 3) {
        fprintf(fnum,"sdinviner:\n");
    }
    if (routine == 4) {
        fprintf(fnum,"sdinvbtj:\n");
    }
    if (routine == 5) {
        fprintf(fnum,"sdinvitj:\n");
    }
    if (routine == 6) {
        fprintf(fnum,"sdinvpin:\n");
    }
    if (routine == 7) {
        fprintf(fnum,"sdinvinit:\n");
    }
    if (routine == 8) {
        fprintf(fnum,"sdinvstate:\n");
    }
    if (routine == 9) {
        fprintf(fnum,"sdinvpsstate:\n");
    }
    if (routine == 13) {
        fprintf(fnum,"sdinvpresacc:\n");
    }
    if (routine == 14) {
        fprintf(fnum,"sdinvpresvel:\n");
    }
    if (routine == 15) {
        fprintf(fnum,"sdinvprespos:\n");
    }
    if (routine == 10) {
        fprintf(fnum,"sdinvhinget:\n");
    }
    if (routine == 11) {
        fprintf(fnum,"sdinvpointf:\n");
    }
    if (routine == 12) {
        fprintf(fnum,"sdinvbodyt:\n");
    }
    if (routine == 17) {
        fprintf(fnum,"sdinvderiv:\n");
    }
    if (routine == 16) {
        fprintf(fnum,"sdinvresid:\n");
    }
    if (routine == 18) {
        fprintf(fnum,"sdinvpseudo:\n");
    }
    if (routine == 19) {
        fprintf(fnum,"sdinvmom:\n");
    }
    if (routine == 20) {
        fprintf(fnum,"sdinvsys:\n");
    }
    if (routine == 21) {
        fprintf(fnum,"sdinvpos:\n");
    }
    if (routine == 22) {
        fprintf(fnum,"sdinvvel:\n");
    }
    if (routine == 23) {
        fprintf(fnum,"sdinvorient:\n");
    }
    if (routine == 24) {
        fprintf(fnum,"sdinvangvel:\n");
    }
    if (routine == 25) {
        fprintf(fnum,"sdinvtrans:\n");
    }
    if (routine == 26) {
        fprintf(fnum,"sdinvperr:\n");
    }
    if (routine == 27) {
        fprintf(fnum,"sdinvverr:\n");
    }
    if (routine == 28) {
        fprintf(fnum,"sdinvpsqdot:\n");
    }
    if (routine == 29) {
        fprintf(fnum,"sdinvpsudot:\n");
    }
    if (routine == 30) {
        fprintf(fnum,"sdinvgetht:\n");
    }
    if (routine == 31) {
        fprintf(fnum,"sdinvreac:\n");
    }
    if (routine == 32) {
        fprintf(fnum,"sdinvacc:\n");
    }
    if (routine == 33) {
        fprintf(fnum,"sdinvangacc:\n");
    }
    if (routine == 34) {
        fprintf(fnum,"sdinvmult:\n");
    }
    if (routine == 35) {
        fprintf(fnum,"sdinvaerr:\n");
    }
    if (routine == 36) {
        fprintf(fnum,"sdinvindx:\n");
    }
    if (routine == 37) {
        fprintf(fnum,"sdinvpres:\n");
    }
    if (routine == 38) {
        fprintf(fnum,"sdinvstab:\n");
    }
    if (routine == 39) {
        fprintf(fnum,"sdinvgetgrav:\n");
    }
    if (routine == 40) {
        fprintf(fnum,"sdinvgetmass:\n");
    }
    if (routine == 41) {
        fprintf(fnum,"sdinvgetiner:\n");
    }
    if (routine == 42) {
        fprintf(fnum,"sdinvgetbtj:\n");
    }
    if (routine == 43) {
        fprintf(fnum,"sdinvgetitj:\n");
    }
    if (routine == 44) {
        fprintf(fnum,"sdinvgetpin:\n");
    }
    if (routine == 45) {
        fprintf(fnum,"sdinvgetpres:\n");
    }
    if (routine == 46) {
        fprintf(fnum,"sdinvgetstab:\n");
    }
    if (routine == 47) {
        fprintf(fnum,"sdinvinfo:\n");
    }
    if (routine == 48) {
        fprintf(fnum,"sdinvjnt:\n");
    }
    if (routine == 49) {
        fprintf(fnum,"sdinvcons:\n");
    }
    if (routine == 50) {
        fprintf(fnum,"sdinvassemble:\n");
    }
    if (routine == 51) {
        fprintf(fnum,"sdinvinitvel:\n");
    }
    if (routine == 52) {
        fprintf(fnum,"sdinvstatic:\n");
    }
    if (routine == 53) {
        fprintf(fnum,"sdinvsteady:\n");
    }
    if (routine == 54) {
        fprintf(fnum,"sdinvmotion:\n");
    }
    if (routine == 55) {
        fprintf(fnum,"sdinvfmotion:\n");
    }
    if (routine == 56) {
        fprintf(fnum,"sdinvequivht:\n");
    }
    if (routine == 57) {
        fprintf(fnum,"sdinvmassmat:\n");
    }
    if (routine == 58) {
        fprintf(fnum,"sdinvfrcmat:\n");
    }
    if (routine == 59) {
        fprintf(fnum,"sdinvrel2cart:\n");
    }
    if (routine == 60) {
        fprintf(fnum,"sdinvcomptrq:\n");
    }
    if (routine == 61) {
        fprintf(fnum,"sdinvfulltrq:\n");
    }
    if (routine == 62) {
        fprintf(fnum,"sdinvvrot:\n");
    }
    if (errnum == 1) {
    ...
    if (errnum == 22) {
        fprintf(fnum,"sdinvinit must be called first\n");
    }
    if (errnum == 23) {
        fprintf(fnum,"sdinvstate must be called first\n");
    }
    if (errnum == 24) {
        fprintf(fnum,"sdinvderiv must be called first\n");
    }
    if (errnum == 25) {
...
void sdinvprinterr(FILE *fnum)
{

    sdinvprerrmsg(fnum,lastrou,lasterr);
}

void sdinvclearerr(void)
{
    ...
    double x[])
{
    ...
    sdinvldubsl(n,na,map,l,b,work);
    sdinvldubsdinv(n,na,map,d,work,work);
    sdinvldubsu(n,na,map,l,work,x);
}

void sdinvlduslv(int n,
    int na,
    int map[],
    double tol,
    double work1[],
    ...
    double x[])
{
    ...
    sdinvldudcomp(n,na,map,tol,work1,work2,m,l,d);
    sdinvldubslv(n,na,map,work2,l,d,b,x);
}
    ...
    int *rank)
{
    ...
    if (k  !=  0) {
        sdinvqrsl(nr,nc,nra,nca,mapr,mapc,k,work,w,qraux,b,x);
    }
    for (j = k; j <= nca-1; j++) {
        x[mapc[j]] = 0.;
    }
    ...
    int *rank)
{
    ...
    sdinvqrdcomp(nr,nc,nra,nca,mapr,mapc,w,qraux,jpvt);
    sdinvqrbslv(nr,nc,nra,nca,mapr,mapc,tol,work,iwork,w,qraux,jpvt,b,x,rank);
}
    ...
    double x[])
{
    ...
    if (ndes  ==  0) {
        ...
        sdinvqrslv(nra,nra,nra,nra,&iw[map],&iw[map],tol,&iw[jpvt],&rw[qraux],&rw[
        ...
        sdinvqrslv(dsiz,dsiz,dsiz,dsiz,&iw[map],&iw[map],tol,&iw[jpvt],&rw[qraux],&
...
/* Utility routines for use with sdinvroot. */


void sdinvcalcerrs(double fval[],
    int nfunc,
    int ndes,
    int dnorm,
    double *maxderr,
    ...
    double newerrs[])
{
    ...
    *fcnt = *fcnt+1;
    ...
    sdinvcalcerrs(newerrs,nfunc,ndes,dnorm,&maxderr,&maxrerr,&derrnorm);
    ...
    int *err)
{
    ...
    *fcnt = *fcnt+1;
    sdinvcalcerrs(fret,nfunc,ndes,dnorm,&pmaxderr,&pmaxrerr,&pderrnorm);
    crude = 1e-6;
    for (ntrys = 0; ntrys < 2; ntrys++) {
        ...
        for (;;) {
            ...
            sdinvcalcjac(func,vars,param,nfunc,nvar,lock,crude,fret,&rw[f1]
              ,jw,fcnt,&rw[scale]);
            for (i = 0; i < nfunc; i++) {
                rw[f1+i] = fret[i]*rw[scale+i];
            }
            sdinvlsslv(nfunc,nvar,nfunc,nvar,ndes,&iw[mapf],&iw[mapv],qrtol,dw,&rw[
              morerw],&iw[moreiw],jw,&rw[f1],&rw[deltav]);
            for (;;) {
                sdinvadjvars(func,vars,param,nfunc,ndes,dnorm,nvar,&rw[deltav]
                  ,step,pmaxrerr,pderrnorm,rtol,fcnt,&rw[guess],&rw[f1]);
                sdinvcalcerrs(&rw[f1],nfunc,ndes,dnorm,&maxderr,&maxrerr,&derrnorm)
                  ;
...
/* Utility routine for use with sdinvfinteg and sdinvvinteg.  Work is 2*neq. */


void sdinvrk4m(int (*func)(),
    double time,
    double st[],
    double dst0[],
    double param[],
    ...
    int *status)
{
    ...
    ttime = *time;
    if (step > 0.) {
        sdinvrk4m(func,ttime,st,dst,param,step,&work[nst],neq,&work[morework],&work
          [errs],errest,&which);
        for (i = 0; i < neq; i++) {
            st[i] = work[nst+i];
        }
    ...
    int *which)
{
    ...
    *err = 0;
    ...
    while (ttime  <  tfin) {
        ...
        nstp = stp;
        for (;;) {
            sdinvrk4m(func,ttime,st,dst,param,nstp,&work[xst],neq,&work[morework],&
              work[errs],&maxerr,&wh);
            xtime = ttime+nstp;
            if (maxerr <= tol) {
                errf = 0;
            ...
            if (stp2 < minstep) {
                ...
                sdinvrk4m(func,xtime,&work[xst],&work[xdst],param,stp2,&work[xst2]
...
void sdinvdc2ang(double dircos[3][3],
    double *a1,
    double *a2,
    double *a3)
{
...
void sdinvdc2quat(double dircos[3][3],
    double *e1,
    double *e2,
    double *e3,
    double *e4)
...
double 
sdinvvnorm(double ivec[3])
{
    double norm;

/* Compute the length (norm) of a vector
*/
    norm = sqrt(sdinvvdot(ivec,ivec));
    return norm;
}

void sdinvvcopy(double ivec[3],
    double ovec[3])
{
...
void sdinvvcross(double ivec1[3],
    double ivec2[3],
    double ovec[3])
{
    double tempout[3];
...
*/
    ...
    stheta = sin(theta);
    ctheta = cos(theta);
    sdinvvmul(stheta,ivec,isinvec);
    sdinvvmul(ctheta,ivec,icosvec);
    norm = 1./norm;
    sdinvvmul(norm,rvec,uvec);
    idotu = sdinvvdot(ivec,uvec);
    sdinvvcross(uvec,isinvec,uxisin);
    dotcos = idotu*(1.-ctheta);
    sdinvvaxpy(dotcos,uvec,icosvec,ovec);
    sdinvvadd(ovec,uxisin,ovec);
}

void sdinvserialno(int *serno)
{
